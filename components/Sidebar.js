...
function Sidebar() {
  ...
  return (
    <div className="space-y-2 min-w-max max-w-lg">
      {/* Top */}
      <div
        className="bg-white dark:bg-[#1D2226] border-gray-300 dark:border-none
       rounded-lg overflow-hidden relative flex flex-col items-center text-center border "
      >
        <div className="relative w-full h-14">
          <Image src="/side.png" alt="" layout="fill" priority />
        </div>
        <Avatar
        ...
        <div className="mt-5 py-4 space-x-0.5">
          ...
          <p className="text-black/60 dark:text-white/75">{session?.user?.email}</p>
        </div>

        <div className="hidden md:inline dark:text-white/75 text-left text-sm">
          ...
          <div className="sidebarButton">
            ...
            <h4 className="dark:text-white font-medium">
              <span
                className="w-3 h-3 bg-gradient-to-tr from-yellow-700 to-yellow-200
      ...
      {/* Bottom */}
      <div
        className="hidden md:flex bg-white dark:bg-[#1D2226] text-black/70 dark:text-white/75 border-gray-300 dark:border-none
      rounded-lg overflow-hidden flex-col space-y-2 pt-2.5
      sticky top-20 border "
      >
